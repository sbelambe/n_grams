...
class NGramModel:
    ...
    def __init__(self, n, train_data, alpha=1e-10):
        self.n = n
        self.alpha = alpha
    ...
    def preprocess(self):
        ...
        self.vocab = {word: count for word, count in self.vocab.items() if count >= 5}
...
class InterpolatedNGramModel:
    """ Class for interpolated n-gram models. """
    ...
    def get_interpolated_probability(self, context, word):
        """ Get the interpolated probability of a word given a context. """
...
if __name__ == "__main__":
    ...
    # train_data = load_data("1b_benchmark.train.tokens")[:30765]  # 61530 / 2 = 30765
